...
/*****
 * From Tilemap Studio (https://github.com/Rangi42/tilemap-studio/blob/master/src/themes.cpp)
 * Windows-specific code was removed. Brushed metal was removed due to needing a PNG.
 * Licence: LGPL
 *****/
...
void Themes::use_greybird_theme() {
	use_greybird_scheme();
	use_greybird_colors();
	use_native_settings();
...
void Themes::use_rose_gold_theme() {
...
void Themes::use_high_contrast_theme() {
...
void Themes::use_native_settings() {
	Fl::visible_focus(0);
...
Themes::Theme Themes::_current_theme = Theme::GREYBIRD;
